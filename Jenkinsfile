pipeline {
    ...
    stages {
        ...
        stage('Deploy to AWS') {
            steps {
                sshagent(['my-ssh-key']) {
                    sh 'scp -o StrictHostKeyChecking=no -r backend ubuntu@ec2-52-78-152-77.ap-northeast-2.compute.amazonaws.com:/home/ubuntu/'
                    sh 'scp -o StrictHostKeyChecking=no -r frontend ubuntu@ec2-52-78-152-77.ap-northeast-2.compute.amazonaws.com:/home/ubuntu/'
                    sh 'scp -o StrictHostKeyChecking=no docker-compose.yml ubuntu@ec2-52-78-152-77.ap-northeast-2.compute.amazonaws.com:/home/ubuntu/'
                    sh '''
